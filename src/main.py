...
class ASRComparisonTool:
    ...
    def _init_ui(self):
        ...
        # 设置canvas的高度 - 提高高度从120到160
        self.asr_canvas = tk.Canvas(self.asr_canvas_frame, bg="white", height=160)  # 原来是120，现在增加到160
        ...
        # 设置canvas的高度 - 提高高度从120到160
        self.ref_canvas = tk.Canvas(self.ref_canvas_frame, bg="white", height=160)  # 原来是120，现在增加到160
        ...
        # 结果展示表格，设置高度 - 将行数从12改回到8
        columns = ("原始文件", "标注文件", "ASR字数", "标注字数", "字准确率", "过滤语气词")
        self.result_tree = ttk.Treeview(self.result_tree_frame, columns=columns, show="headings", height=8)  # 改回原来的8行
        for col in columns:
