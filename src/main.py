...
class ASRComparisonTool:
    ...
    def _init_ui(self):
        # 上半部分 - 文件选择区域
        self.left_frame = ttk.LabelFrame(self.top_frame, text="ASR转换结果文件")
        self.left_frame.pack(side=tk.LEFT, fill=tk.BOTH, expand=True, padx=5, pady=5)
        
        self.right_frame = ttk.LabelFrame(self.top_frame, text="标注文件")
        ...
        self.asr_canvas = tk.Canvas(self.left_frame, bg="white")
        self.asr_canvas.pack(fill=tk.BOTH, expand=True, padx=5, pady=5)
        ...
        self.ref_canvas = tk.Canvas(self.right_frame, bg="white")
        self.ref_canvas.pack(fill=tk.BOTH, expand=True, padx=5, pady=5)
        ...
        # 统计按钮
        self.calculate_btn = ttk.Button(self.top_frame, text="开始统计", command=self.calculate_accuracy)
        self.calculate_btn.pack(side=tk.BOTTOM, pady=10)
        ...
        # 导出按钮
        self.export_btn = ttk.Button(self.bottom_frame, text="导出结果", command=self.export_results)
